...
# 4. PROCESS THE IMAGES WITH GAUSSIAN NOISE, THEN SAVE TO DISK
...
processed_images_dir = "processed_images_gaussian_noise_test"
...
processed_batches_dir = "processed_batches_gaussian_noise_test"
os.makedirs(processed_batches_dir, exist_ok=True)

# save the processed batches and the labels into pickle files
for i, (data_batch, label_batch) in tqdm.tqdm(enumerate(zip(processed_batches, label_batches))):
    output_dict = {
